package com.distribute.job.executor.sample.frameless.config;

import com.distribute.job.core.executor.impl.XxlJobSimpleExecutor;
import com.distribute.job.executor.sample.frameless.jobhandler.SampleXxlJob;
